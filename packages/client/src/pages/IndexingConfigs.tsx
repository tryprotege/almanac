...
export default function IndexingConfigs() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "disabled":
        return (
          <span className="px-2 py-1 text-xs font-medium rounded-full bg-error-100 text-error-700 dark:bg-error-900/30 dark:text-error-400">
            Disabled
          </span>
        );
      default:
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Manage auto-generated configs for MCP server indexing
              </p>
            </div>
            <button
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {config.status === "active" && (
                            <button
                              onClick={() =>
                                handleSync(config.serverName, false)
                              }
