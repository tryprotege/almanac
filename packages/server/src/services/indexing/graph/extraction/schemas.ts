...
export const COMBINED_EXTRACTION_SCHEMA: Record<string, unknown> = {
  ...
  properties: {
    entities: {
      ...
      items: {
        ...
        properties: {
          name: {
            type: 'string',
            description: 'The canonical name of the entity as it appears in the content',
          },
          type: {
            type: 'string',
            description:
    ...
    relationships: {
      type: 'array',
      description: 'List of meaningful connections between entities extracted from the content',
      items: {
        type: 'object',
        properties: {
          source: {
          ...
          description: {
            type: 'string',
            description: 'A brief explanation of how the source and target entities are related',
          },
          strength: {
            type: 'number',
            description:
